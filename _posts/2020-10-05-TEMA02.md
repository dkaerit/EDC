...
### 8.5. Direccionamiento relativo o con desplazamiento
--. 
...
#### 8.5.1 Relativo a Registro base
La dirección base la contiene un `Registro` y el desplazamiento es una `constante` (sin signo).
<center><img src="https://i.gyazo.com/2d5c3158c04140a77bdde4f35f602388.png"></center>

### 8.5.2 Indexado
La dirección base la contiene una dirección de  `Memoria` y el desplazamiento es un `Registro` que hace de índice.
<center><img src="https://i.gyazo.com/160f9a7bb0b43376d27a038251320f4a.png"></center>


### 8.6. Direccionamiento de pila
