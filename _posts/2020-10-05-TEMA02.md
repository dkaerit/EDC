...
### 5.2. Estructura de la instrucción
  ...
  * Poseen un número determinado de operandos (Clasificación de los repertorios)
...
## 7. Condiciones deseables de una codificación
- 
...
### 8.2. Direccionamiento inmediato
El operando está en la propia inrucción. 
<center><img src="https://i.gyazo.com/451c0df2ec1e20cde478d586c533d8c8.png"></center>

### 8.3. Direccionamiento directo de registro y de memoria
Un campo de direcciones (registros o memoria) contiene la dirección del operando. 
<center><img src="https://i.gyazo.com/60b7f10ea99677cfc01d5ccbc392d698.png"></center>

### 8.4. Direccionamiento indirecto de registro y de memoria
Existe para poder doyar de mayor flexibildad al programa ante una perspectiva en la que solo se podían manejar variables globales o estáticas. 
<center><img src="https://i.gyazo.com/88c28326a20240f738c5f8244c6da5f8.png"></center>

### 8.5. Direccionamiento relativo a PC
Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. 

### 8.6. Direccionamiento relativo a registro base
Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. 

### 8.7. Direccionamiento indexado
Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. 

### 8.8. Direccionamiento de pila
Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. 

## 9. Ventajas y desventajas de los modos de direccionamientos
Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. 


## 10. Rendimiento de un computador
Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. 
...
## 12. Tipos de computadores
Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. 

## 13. Rendimiento según el tipo de computador. 
Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. 

## 14. Mejoras del rendimiento computacional: paralelismo y clasificación de Flynn
...
### 14.1. Paralelismo potencial en aplicaciones
### 14.2. Paralelismo en el hardware
### 14.3. Paralelismo a nivel de instrucción


## 15. Ejecución de instrucciones en paralelo
Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. 
...
### 16.2. Paralelismo a nivel de instrucción: más allá de la segmentación
### 16.3. Paralelismo a nivel de instrucción: aproximaciones
### 16.4. Paralelismo a nivel de hilo

## 17. Comparación de diferentes tipos de paralelismo
