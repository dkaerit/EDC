...
<center><img src="https://i.imgur.com/LGJD7qc.gif" width="90%"></img></center>
...
<center><img src="https://i.imgur.com/o2QOCWo.gif" width="90%"></img></center>
...
# Problemas
## P1. Diseñando un ISA
Si una CPU posee instrucciones que tienen como máximo M referencias explícipas a memoria (direcciones), se dice que es una máquina de M-direcciones.

La expresividad de un lenguaje es la capacidad de expresar soluciones a problemas complejos de forma elegante (que el lenguaje se pueda entender), simple (QUe con un sólo vistazo se pueda comprender) y concisa (que sea breve, que una solución se pueda aplicar con pocas líneas)
