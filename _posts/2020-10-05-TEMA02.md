...
Fynn: Por cada flujo podemos tener un único flujo (single-S) o múltiples (Multiple-M), y pueden ser de instrucciones (I) o de datos (D).
...
MISD, multiples flujos (el programa se puede resolver en varios flujos difernetes: Intercambiar información), paralelizar la tarea,
