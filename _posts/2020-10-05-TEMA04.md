...
<center><img src="https://i.gyazo.com/e00611c6883a343f1ede68c5d76d53c4.png"></center>
...
<center><img src="https://i.gyazo.com/5d4c6b69929d87bead24576ae43c6429.png"></center>

### 5.3. Booth

```print
bit(i)    bit(i-1)    new_bit(i)      operación
————————————————————————————————————————————————
0         0           0               desplazamiento
0         1           1               suma y desplazamiento
1         0           -1              resta y desplazamiento
1         1           0               desplazamiento
```
...
El peor caso para el algoritmo de Booth serían cadenas alternadas de 0 y 1

<center><img src="https://i.gyazo.com/b696a7c9a4787003f73a35dbdd5b34d4.png"></center>
